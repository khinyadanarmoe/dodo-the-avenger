...
public class Boss extends Enemy {
    ...
    private static final int BOSS_WIDTH = BOARD_WIDTH;
    ...
    private final Rectangle[] clips = new Rectangle[] {
            new Rectangle(0, 0, 192, 128),
            new Rectangle(0, 128, 192, 128),
    ...
    public void act() {
        ...
        if (frame < 100) {
            ...
            frame = 0; // Reset frame for next cycle
        }
    ...
    public static int getBossWidth() {
        return BOSS_WIDTH;
    }

    public static int getBossHeight() {
        return BOSS_HEIGHT;
    }
}
